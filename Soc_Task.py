...
#         bot.apply_action(ArticulationAction(joint_velocities=np.array([10, 10, 10, 10]), joint_indices=np.array([13, 16, 24, 25])))
#     return None
...
#     for _ in range(n_steps):
#         bot.apply_action(ArticulationAction(joint_velocities=np.array([0, 0, 0, 0]), joint_indices=np.array([13, 16, 24, 25])))
#     return None

def go_forward(bot):
    bot.apply_wheel_actions(ArticulationAction(joint_velocities=np.array([5, 0, 5, 0]), joint_indices=np.array([13, 16, 24, 25])))
    return None

def go_backward(bot):
    bot.apply_wheel_actions(ArticulationAction(joint_velocities=np.array([0, -4, 0, -4]), joint_indices=np.array([13, 16, 24, 25])))
    return None

def turn_right(bot):
    bot.apply_wheel_actions(ArticulationAction(joint_velocities=np.array([-4, 4, -4, 4]), joint_indices=np.array([13, 16, 24, 25])))
    return None
...
def stay(bot):
    bot.apply_wheel_actions(ArticulationAction(joint_positions=np.array([0, 0, 0, 0]), joint_indices=np.array([13, 16, 24, 25])))
    return None

def bot_act(bot, action):
    if action == 0:
        stay(bot)
    elif action == 1:
        go_forward(bot)
...
# i = 0
# lea_camera.add_motion_vectors_to_frame()

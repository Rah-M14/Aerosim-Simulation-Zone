...
while true; do
    ...
    ./python.sh "/isaac-sim/standalone_examples/api/omni.isaac.kit/NAV_TEST/Docker_Trainer.py" --algo $algo --botname jackal --wandb_project $wandb_p --state_normalize --resume_checkpoint --headless -g $gpu
